...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting fast-syntax-highlighting zsh-autocomplete docker sudo asdf flutter)
...
alias updy='yay -Syu --noconfirm'
alias inty='yay -S --noconfirm'
alias rmvy='yay -Rs --noconfirm'
